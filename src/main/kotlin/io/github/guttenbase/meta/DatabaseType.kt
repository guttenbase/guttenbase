...
enum class DatabaseType(
  ...
  private val selectViewDefinitionClause: String? = null,
  private val escapeDatabaseEntities: Boolean = true
) {
  // Dummy value
  GENERIC(
    "IDENTITY($NEXT_VALUE, 1)", null,
  ...
  IBMDB2("GENERATED BY DEFAULT AS IDENTITY (START WITH $NEXT_VALUE, INCREMENT BY $STEP_VALUE)"),
