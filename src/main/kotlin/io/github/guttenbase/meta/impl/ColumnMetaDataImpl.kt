...
class ColumnMetaDataImpl(
  ...
  override operator fun compareTo(other: ColumnMetaData) = columnName.uppercase().compareTo(other.columnName.uppercase())
  ...
  override fun equals(other: Any?): Boolean {
    val that: ColumnMetaData = other as ColumnMetaData
    return columnName.equals(that.columnName, ignoreCase = true)
  }
