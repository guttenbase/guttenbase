 ...
 *
 *
 * Hint is used by [AbstractStatementCreator] to determine column order
 * Hint is used by [InsertStatementFiller] to determine column order
 * Hint is used by [CheckEqualTableDataTool] to determine column order
 *
 * @author M. Dahm
 */
