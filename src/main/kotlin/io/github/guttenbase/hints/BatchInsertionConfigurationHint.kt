 ...
 * @author M. Dahm
 */
abstract class BatchInsertionConfigurationHint : ConnectorHint<BatchInsertionConfiguration> {
  override val connectorHintType = BatchInsertionConfiguration::class.java
}
