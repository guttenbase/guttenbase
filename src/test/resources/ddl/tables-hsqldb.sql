...
ALTER TABLE FOO_USER_COMPANY
    ADD CONSTRAINT FK_FOO_USER_COMPANY_COMPANY FOREIGN KEY (ASSIGNED_COMPANY_ID) REFERENCES FOO_COMPANY (ID);
ALTER TABLE FOO_USER_COMPANY
    ADD CONSTRAINT FK_FOO_USER_COMPANY_USER FOREIGN KEY (USER_ID) REFERENCES FOO_USER (ID);
...
ALTER TABLE FOO_USER_ROLES
    ADD CONSTRAINT FKFOO_USER_ROLES FOREIGN KEY (ROLE_ID) REFERENCES FOO_ROLE (ID);
ALTER TABLE FOO_USER_ROLES
    ADD CONSTRAINT FKFOO_USER_ROLES2 FOREIGN KEY (USER_ID) REFERENCES FOO_USER (ID);
